...
public class ConnectionPool {
	...
	private ConnectionPool() {
		...
		this.driverName = dbResourseManager.getValue(DBParameter.BD_DRIVER);
	...
	public void initPoolData() throws ConnectionPoolException {
		...
		try {
			...
			throw new ConnectionPoolException("Cant find DatabaseDriver", e);
	...
	public Connection takeConnection() throws ConnectionPoolException {
		...
		try {
			...
			throw new ConnectionPoolException("error connection to the data sourse", e);
		}
		return connection;
	}
	...
	private class PooledConnection implements Connection {
		...
		public void close() throws SQLException {
			if (connection.isClosed()) {
				throw new SQLException("Atteping to close connection");
			...
			if (!connectionQueue.offer(this)) {
				throw new SQLException("Error allocating connetion in the pool");
